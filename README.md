...
4. **Live demo — Pembukuan:** Show today's profit summary generated by Gemini in Bahasa Indonesia
...
- AI features are additive — app works without Gemini API if key is missing (graceful degradation)
